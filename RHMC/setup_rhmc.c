...
// Nroot 1 gives errors 9.402444e-06 and 5.074920e-06
// Nroot 1 gives errors 5.074920e-06 and 2.585435e-06
void setup_rhmc17() {
  if (Nroot == 1) {
    // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D17
    ...
    // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D17
    ...
    // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D17
    ...
    // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D17
    ...
    // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N2.D17
    ampdeg4 = 2.7319580141958955e-01;
    amp4[0] = 5.8823531984206132e-08;
    amp4[1] = 2.3946566014604335e-07;
    amp4[2] = 9.3253429393734557e-07;
    amp4[3] = 3.6561356376572671e-06;
    amp4[4] = 1.4364387498292607e-05;
    amp4[5] = 5.6461787039729985e-05;
    amp4[6] = 2.2195510388015686e-04;
    amp4[7] = 8.7253906119992130e-04;
    amp4[8] = 3.4301058747753903e-03;
    amp4[9] = 1.3484518263348387e-02;
    amp4[10] = 5.3013527499218338e-02;
    amp4[11] = 2.0847272672941036e-01;
    amp4[12] = 8.2081202079206683e-01;
    amp4[13] = 3.2507404714849568e+00;
    amp4[14] = 1.3240848632890867e+01;
    amp4[15] = 6.1797616519257247e+01;
    amp4[16] = 5.8819149395555985e+02;

    // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N2.D17
    shift4[0] = 1.6803999560431352e-08;
    shift4[1] = 1.5399240785757979e-07;
    shift4[2] = 8.2523448514894683e-07;
    shift4[3] = 4.0372081954992101e-06;
    shift4[4] = 1.9392029358782271e-05;
    shift4[5] = 9.2792553976486796e-05;
    shift4[6] = 4.4366784787376243e-04;
    shift4[7] = 2.1209515114118519e-03;
    shift4[8] = 1.0138856396106904e-02;
    shift4[9] = 4.8467056277158131e-02;
    shift4[10] = 2.3169468241568883e-01;
    shift4[11] = 1.1077574841077449e+00;
    shift4[12] = 5.2997701942716651e+00;
    shift4[13] = 2.5434759389770836e+01;
    shift4[14] = 1.2391785608047525e+02;
    shift4[15] = 6.5027486909542131e+02;
    shift4[16] = 5.1910896457795752e+03;

    // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N2.D17
    ampdeg8 = 1.9120608307750344e+00;
    amp8[0] = -1.2723798036781749e-09;
    amp8[1] = -7.5566929907461411e-09;
    amp8[2] = -4.0219754688522530e-08;
    amp8[3] = -2.1229027214764527e-07;
    amp8[4] = -1.1192488199729725e-06;
    amp8[5] = -5.8997184983133171e-06;
    amp8[6] = -3.1096911862200753e-05;
    amp8[7] = -1.6390779591532795e-04;
    amp8[8] = -8.6393772827554518e-04;
    amp8[9] = -4.5537721444818052e-03;
    amp8[10] = -2.4004338130138837e-02;
    amp8[11] = -1.2657552810623532e-01;
    amp8[12] = -6.6847719990271448e-01;
    amp8[13] = -3.5568129671963353e+00;
    amp8[14] = -1.9613976840061142e+01;
    amp8[15] = -1.2872748839034739e+02;
    amp8[16] = -2.1544482595001487e+03;

    // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N2.D17
    shift8[0] = 2.2144248345689134e-08;
    shift8[1] = 1.8208700187944502e-07;
    shift8[2] = 9.5994626516343153e-07;
    shift8[3] = 4.6808290080862901e-06;
    shift8[4] = 2.2466805568273845e-05;
    shift8[5] = 1.0748184107253685e-04;
    shift8[6] = 5.1384394330568437e-04;
    shift8[7] = 2.4562086982119046e-03;
    shift8[8] = 1.1740508127309332e-02;
    shift8[9] = 5.6118855050977461e-02;
    shift8[10] = 2.6825294660905474e-01;
    shift8[11] = 1.2824744728089221e+00;
    shift8[12] = 6.1359409536534200e+00;
    shift8[13] = 2.9463547473987340e+01;
    shift8[14] = 1.4396513728959229e+02;
    shift8[15] = 7.6695256022113119e+02;
    shift8[16] = 6.7537485613941853e+03;
  }
}
// -----------------------------------------------------------------
...
// Nroot 3 gives errors 7.043397e-06 and 3.550962e-06
void setup_rhmc16() {
  if (Nroot == 1) {
    // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D16
    ...
    // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D16
    ...
    // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D16
    ...
    // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D16
    ...
    // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N2.D16
    ...
    // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N2.D16
    ...
    // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N2.D16
    ...
    // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N2.D16
    ...
    // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N3.D16
    ampdeg4 = 4.8651272442129373e-01;
    amp4[0] = 5.1028512024641851e-09;
    amp4[1] = 2.4449808661391835e-08;
    amp4[2] = 1.1136005151542462e-07;
    amp4[3] = 5.0886892876132598e-07;
    amp4[4] = 2.3278215534419324e-06;
    amp4[5] = 1.0650978660404758e-05;
    amp4[6] = 4.8735786428942611e-05;
    amp4[7] = 2.2300287883221978e-04;
    amp4[8] = 1.0204135177629282e-03;
    amp4[9] = 4.6693406860135872e-03;
    amp4[10] = 2.1370065970249860e-02;
    amp4[11] = 9.7887854124219714e-02;
    amp4[12] = 4.5041252182190122e-01;
    amp4[13] = 2.1222934850807444e+00;
    amp4[14] = 1.1345936035359482e+01;
    amp4[15] = 1.2476971218739226e+02;

    // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N3.D16
    shift4[0] = 4.0891033165882983e-09;
    shift4[1] = 3.8496872779776899e-08;
    shift4[2] = 2.2245357906375603e-07;
    shift4[3] = 1.1896018571195772e-06;
    shift4[4] = 6.2712867418616253e-06;
    shift4[5] = 3.2971386701601818e-05;
    shift4[6] = 1.7325849276753123e-04;
    shift4[7] = 9.1035256174564188e-04;
    shift4[8] = 4.7831936017209776e-03;
    shift4[9] = 2.5132275008926071e-02;
    shift4[10] = 1.3206336393577756e-01;
    shift4[11] = 6.9426824044113733e-01;
    shift4[12] = 3.6584310965047804e+00;
    shift4[13] = 1.9519250085049514e+01;
    shift4[14] = 1.1137562322744576e+02;
    shift4[15] = 9.5957257484268746e+02;

    // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N3.D16
    ampdeg8 = 1.4334276218119852e+00;
    amp8[0] = -2.6225573246113791e-10;
    amp8[1] = -1.6280754458785749e-09;
    amp8[2] = -9.2233948084170965e-09;
    amp8[3] = -5.1966817243254352e-08;
    amp8[4] = -2.9260916933015383e-07;
    amp8[5] = -1.6474195120331030e-06;
    amp8[6] = -9.2749623131513802e-06;
    amp8[7] = -5.2217861520276720e-05;
    amp8[8] = -2.9398741611041002e-04;
    amp8[9] = -1.6552145057742405e-03;
    amp8[10] = -9.3210228202494118e-03;
    amp8[11] = -5.2542767820933443e-02;
    amp8[12] = -2.9776636685073526e-01;
    amp8[13] = -1.7354956771043597e+00;
    amp8[14] = -1.1746727647777330e+01;
    amp8[15] = -1.8951812128717765e+02;

    // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N3.D16
    shift8[0] = 4.9177847838317216e-09;
    shift8[1] = 4.3225193965418047e-08;
    shift8[2] = 2.4735232339456305e-07;
    shift8[3] = 1.3203725912068091e-06;
    shift8[4] = 6.9580674464360451e-06;
    shift8[5] = 3.6578232777928485e-05;
    shift8[6] = 1.9220101473859237e-04;
    shift8[7] = 1.0098354946041536e-03;
    shift8[8] = 5.3056645288927819e-03;
    shift8[9] = 2.7876314956918578e-02;
    shift8[10] = 1.4647776316459266e-01;
    shift8[11] = 7.7005823566967657e-01;
    shift8[12] = 4.0589089990939273e+00;
    shift8[13] = 2.1691330265715528e+01;
    shift8[14] = 1.2491211508165769e+02;
    shift8[15] = 1.1475373265840901e+03;
  }
  else {
...
void setup_rhmc15() {
  if (Nroot == 1) {
    // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D15
    ...
    // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D15
    ...
    // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D15
    ...
    // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D15
    ...
    // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N2.D15
    ...
    // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N2.D15
    ...
    // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N2.D15
    ...
    // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N2.D15
...
// -----------------------------------------------------------------
// (13, 13) approximation for spectral range [5e-5, 5000]
// gives errors 9.655804e-06 and 5.207535e-06
void setup_rhmc13() {
  if (Nroot != 1) {
    node0_printf("setup_rhmc: unrecognized Nroot %d\n", Nroot);
    terminate(1);
  ...
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D13
  ampdeg4 = 6.2206955393599973e-02;
  amp4[0] = 1.6848285353541665e-04;
  amp4[1] = 5.2338064801984400e-04;
  amp4[2] = 1.6533750881931315e-03;
  amp4[3] = 5.3271125303278365e-03;
  amp4[4] = 1.7246498856036803e-02;
  amp4[5] = 5.5893653588691534e-02;
  amp4[6] = 1.8119135032352549e-01;
  amp4[7] = 5.8752306936562049e-01;
  amp4[8] = 1.9070500579073184e+00;
  amp4[9] = 6.2206970959780703e+00;
  amp4[10] = 2.0777915067452604e+01;
  amp4[11] = 7.7858776368682243e+01;
  amp4[12] = 5.2966683816011061e+02;

  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D13
  shift4[0] = 1.3676835247681990e-05;
  shift4[1] = 1.3794424840269417e-04;
  shift4[2] = 7.5120149785107759e-04;
  shift4[3] = 3.6970035202075337e-03;
  shift4[4] = 1.7830868113201215e-02;
  shift4[5] = 8.5641717316970553e-02;
  shift4[6] = 4.1099100123578608e-01;
  shift4[7] = 1.9722128414394813e+00;
  shift4[8] = 9.4692060998832037e+00;
  shift4[9] = 4.5592497855547961e+01;
  shift4[10] = 2.2252432239085124e+02;
  shift4[11] = 1.1615328043259224e+03;
  shift4[12] = 8.8234028594217307e+03;

  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D13
  ampdeg8 = 3.9896189321666236e+00;
  amp8[0] = -2.1160057891713894e-06;
  amp8[1] = -1.4210652982457457e-05;
  amp8[2] = -8.4140965601095329e-05;
  amp8[3] = -4.9208846451904347e-04;
  amp8[4] = -2.8721756962033010e-03;
  amp8[5] = -1.6757717211315786e-02;
  amp8[6] = -9.7772127376433704e-02;
  amp8[7] = -5.7063548523312768e-01;
  amp8[8] = -3.3359863254047522e+00;
  amp8[9] = -1.9658973531246072e+01;
  amp8[10] = -1.2039519339286457e+02;
  amp8[11] = -8.9004624340848250e+02;
  amp8[12] = -1.8380488437544929e+04;

  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D13
  shift8[0] = 2.4192516250020111e-05;
  shift8[1] = 1.9349582686313278e-04;
  shift8[2] = 1.0181516733353962e-03;
  shift8[3] = 4.9755637735251637e-03;
  shift8[4] = 2.3954442825876218e-02;
  shift8[5] = 1.1497120637709825e-01;
  shift8[6] = 5.5147655736902479e-01;
  shift8[7] = 2.6453165768424083e+00;
  shift8[8] = 1.2698620346795309e+01;
  shift8[9] = 6.1188282106418086e+01;
  shift8[10] = 3.0025102721136665e+02;
  shift8[11] = 1.6132817300793333e+03;
  shift8[12] = 1.4810284890284607e+04;
}
// -----------------------------------------------------------------
...
// Nroot 1 gives errors 1.977763e-05 and 1.066894e-05
// Nroot 2 gives errors 1.066894e-05 and 5.434572e-06
void setup_rhmc14() {
  if (Nroot == 1) {
    // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D14
    ...
    // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D14
    ...
    // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D14
    ...
    // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D14
    ...
    // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N2.D14
    ampdeg4 = 2.8707614061476772e-01;
    amp4[0] = 9.2076333378286609e-07;
    amp4[1] = 4.0446175648462113e-06;
    amp4[2] = 1.7170849964262899e-05;
    amp4[3] = 7.3381642320130997e-05;
    amp4[4] = 3.1414391855476802e-04;
    amp4[5] = 1.3452993555713470e-03;
    amp4[6] = 5.7615591883506071e-03;
    amp4[7] = 2.4676242203190361e-02;
    amp4[8] = 1.0570242143965101e-01;
    amp4[9] = 4.5314629694346681e-01;
    amp4[10] = 1.9508509568163237e+00;
    amp4[11] = 8.5879175414229980e+00;
    amp4[12] = 4.2574473478742618e+01;
    amp4[13] = 4.1558240439685522e+02;

    // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N2.D14
    shift4[0] = 3.8460942912706409e-07;
    shift4[1] = 3.7244747389455358e-06;
    shift4[2] = 2.1661031438159155e-05;
    shift4[3] = 1.1628439315775908e-04;
    shift4[4] = 6.1514596650186204e-04;
    shift4[5] = 3.2451233958838074e-03;
    shift4[6] = 1.7110291364105374e-02;
    shift4[7] = 9.0208404373209705e-02;
    shift4[8] = 4.7562375124070089e-01;
    shift4[9] = 2.5087871144779519e+00;
    shift4[10] = 1.3262994501235704e+01;
    shift4[11] = 7.0957698057112779e+01;
    shift4[12] = 4.0494096112887928e+02;
    shift4[13] = 3.4311121878889867e+03;

    // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N2.D14
    ampdeg8 = 1.8652631531961219e+00;
    amp8[0] = -3.6051427567814793e-08;
    amp8[1] = -2.3411573201402719e-07;
    amp8[2] = -1.3799104883156706e-06;
    amp8[3] = -8.0789153596603530e-06;
    amp8[4] = -4.7258077834724818e-05;
    amp8[5] = -2.7639739223737621e-04;
    amp8[6] = -1.6165257946717838e-03;
    amp8[7] = -9.4546417155204465e-03;
    amp8[8] = -5.5308476043598655e-02;
    amp8[9] = -3.2388013939229998e-01;
    amp8[10] = -1.9069073267361212e+00;
    amp8[11] = -1.1553379009656840e+01;
    amp8[12] = -8.1583860497980396e+01;
    amp8[13] = -1.4101265220565076e+03;

    // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N2.D14
    shift8[0] = 5.0862459883361453e-07;
    shift8[1] = 4.4343135370670599e-06;
    shift8[2] = 2.5409825606379618e-05;
    shift8[3] = 1.3603283410698798e-04;
    shift8[4] = 7.1917587849026205e-04;
    shift8[5] = 3.7931325891586592e-03;
    shift8[6] = 1.9997119647636463e-02;
    shift8[7] = 1.0541627603267574e-01;
    shift8[8] = 5.5575311835761720e-01;
    shift8[9] = 2.9313733316982362e+00;
    shift8[10] = 1.5502495610328728e+01;
    shift8[11] = 8.3134974639193175e+01;
    shift8[12] = 4.8090147718127872e+02;
    shift8[13] = 4.4800441127053627e+03;
  }
  else {
    node0_printf("setup_rhmc: unrecognized Nroot %d\n", Nroot);
    terminate(1);
...
void setup_rhmc12() {
  ...
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D12
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D12
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D12
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D12
...
void setup_rhmc11() {
  ...
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D11
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D11
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D11
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D11
...
void setup_rhmc10() {
  ...
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D10
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D10
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D10
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D10
...
void setup_rhmc9() {
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D9
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D9
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D9
...
void setup_rhmc8() {
  ...
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D8
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D8
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D8
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D8
...
void setup_rhmc7() {
  ...
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D7
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D7
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D7
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D7
...
void setup_rhmc6() {
  ...
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D6
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D6
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D6
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D6
...
void setup_rhmc5() {
  ...
  // awk '/res_MD/{print("amp4["$2"] =",$3";")}' < remez/out.N1.D5
  ...
  // awk '/pole_MD/{print("shift4["$2"] =",$3";")}' < remez/out.N1.D5
  ...
  // awk '/res_GR/{print("amp8["$2"] =",$3";")}' < remez/out.N1.D5
  ...
  // awk '/pole_GR/{print("shift8["$2"] =",$3";")}' < remez/out.N1.D5
